...
\begin{document}
	...
	%----------------------------------------------------------------------------------------
    \cvSection{O mnie}	
    \CVTextBlock{ Zmotywowany inżynier automatyki i robotyki wyposażony w blisko trzy i pół roku doświadczenia w zakresie sprzętu i oprogramowania. Od początku w dziedzinie awioniki UTM i UAV, w szczególności dronów. Zawsze szukający nowych wyzwań i poszerzania wiedzy.}
	%---------------------------------------------------------------------------------------
	%	Current Position
	%----------------------------------------------------------------------------------------
